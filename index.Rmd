...
habitat_map <- reactive({
  ...
  names(cols) <- c("Shrub and Brushland", "Pine Flatwoods", "Freshwater Wetlands", 
                 "Mangrove Forests", "Salt Marshes", "Oyster Bars", "Seagrasses")
...
mainPanel(
  column(5,
         selectInput('yrselseas', 'Select economic impact:', selected = "Output", choices = list("Output", "Employment","Income"))),
  column(7,
...
mainPanel(
  column(6,
         selectInput('habitat_selection', 'Select habitat:', selected = "Oyster Bars", choices = c("Shrub and Brushland", "Pine Flatwoods", "Freshwater Wetlands", "Mangrove Forests", "Salt Marshes", "Oyster Bars", "Seagrasses"))))
```
<br>
<br>
...
output$habitat_map <- renderMapview(habitat_map())
mapviewOutput("habitat_map")
